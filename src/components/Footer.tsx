        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="font-display text-2xl font-bold">
                <span className="text-primary-400">Ziddi</span> Mumbaikar
              </h3>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Ziddi Mumbaikar is a Mumbai-based NGO and social service organization founded in 2018 with a strong commitment to uplifting underserved communities. Driven by the belief that determination (“zidd”) can change lives, we work to empower individuals and families by providing essential support, resources, and opportunities.
            </p>

            {/* Social Media */}
            <div className="flex space-x-4">
              {/* Facebook */}
              <a href="https://www.facebook.com/people/Prakash-Mahadev-Khot/100007152093772/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-500 rounded-full flex items-center justify-center hover:bg-primary-600 transition-colors" aria-label="Facebook">
              ...
              {/* Youtube */}
              <a href="https://www.youtube.com/@ziddimumbaikarngo6627" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-500 rounded-full flex items-center justify-center hover:bg-primary-600 transition-colors" aria-label="Youtube">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/ziddi_mumbaikar_ngo/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-500 rounded-full flex items-center justify-center hover:bg-primary-600 transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/919773344447" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-500 rounded-full flex items-center justify-center hover:bg-primary-600 transition-colors" aria-label="WhatsApp">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 md:grid-cols-1 gap-x-4 gap-y-2">
              ...
              <li><Link href="/#gallery" className="text-gray-300 hover:text-primary-400 transition-colors">Gallery</Link></li>
              <li><Link href="/volunteer" className="text-gray-300 hover:text-primary-400 transition-colors">Get Involved</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div>
                <p className="text-gray-300 text-sm">Emergency Helpline</p>
                <p className="font-semibold text-primary-400">+91 97733 44447</p>
              </div>
              <div>
