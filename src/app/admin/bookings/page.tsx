                        ...
                        <div className="border border-gray-300 p-8">
                            ...
                            <div className="space-y-0 text-[13px]">
                                ...
                                <div className="grid grid-cols-2 gap-0 border-t border-l border-gray-200">
                                    ...
                                    {((printingBooking as any).service?.slug === 'ambulance-booking' || (printingBooking as any).service?.slug === 'ambulance-service' || (printingBooking as any).service?.slug === 'funeral-service' || (printingBooking as any).service?.slug === 'funeral-booking' || (printingBooking as any).service?.slug === 'funeral-van-service') && (
                                        <>
                                            <div className="border-r border-b border-gray-200 p-3">
